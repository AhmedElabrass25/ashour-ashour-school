...
export function DesktopSubmissionsTable({ submissions, onOpen }: Props) {
  return (
            ...
            {submissions.map((item) => (
              ...
              >
                ...
                <td className="py-4 px-5 text-center">
                  <button
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-blue-600 hover:bg-blue-700 text-white text-xs md:text-sm font-bold transition-colors shadow-2xs cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                      onOpen(item);
                    }}
